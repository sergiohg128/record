    ...
    <div class="row cuerpo">
      <div class="row titulo center">
        ...
        <div class="row">
            <a href="tipo-grupo-formulario" class="btn-floating btn-large waves-effect red"><i class="material-icons">add</i></a>
               ...
               <tbody id="filas">
                 @forelse($tipos as $tipo)
                    <tr id="fila{{$tipo->id}}">
                       <td>{{$w = $w + 1}}</td>
                       <td>{{$tipo->nombre}}</td>
                       <td><a href="tipo-grupo-formulario?id={{$tipo->id}}" class="btn green"><i class="material-icons">edit</i></a></td>
